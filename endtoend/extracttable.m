% img8=im2bw(img);
 img4=rgb2gray(img);
% imwrite(img4,strcat('C:\Users\rajde\OneDrive\Documents\clg\form dataset\endtoend\',strcat('69gray','.bmp')),'bmp');
% %img3 = img;
...
for i=1:n
    if stats(i).Area>6
        ...
        imwrite(test_gray_cc,strcat('C:\Users\rajde\OneDrive\Documents\clg\form dataset\grayscale\',strcat(ch,'.bmp')),'bmp');
...
imwrite(fi,strcat('C:\Users\rajde\OneDrive\Documents\clg\form dataset\endtoend\',strcat('tntsep','.bmp')),'bmp');
