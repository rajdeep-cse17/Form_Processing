savingFile = 'C:\Users\rajde\OneDrive\Documents\clg\form dataset\char_num_samir_da_printed_final_120features.csv';
savingFile2 = 'C:\Users\rajde\OneDrive\Documents\clg\form dataset\char_num_samir_da_handwritten_final_120features.csv';
for page=2:70
        ...
        test_gray_cc=uint8(test_gray_cc);
         ...
         pc=0;
           ...
           out1=getfeatures(z,test_gray_cc);
            ...
            output=horzcat(out1,out2,out3,out4,out5);
